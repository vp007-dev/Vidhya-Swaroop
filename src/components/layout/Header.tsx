      ...
      <nav className="container px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 sm:h-20 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Mobile Menu Toggle */}
            <button
              className="lg:hidden relative z-50 p-2 text-foreground active:scale-90 transition-transform hover:bg-secondary rounded-xl"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            transition={{ duration: 0.2 }}
            className="fixed inset-x-0 top-[64px] sm:top-[80px] bottom-0 z-40 bg-background/95 backdrop-blur-2xl border-t border-border overflow-y-auto lg:hidden"
          >
